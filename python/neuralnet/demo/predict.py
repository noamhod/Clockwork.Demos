...
text = "{} at {:.2f}%".format(label, preds[0][i] * 100)
cv2.putText(output, text, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)

print "preds:",preds
print "predssum:",preds[0][0]+preds[0][1]
print "Decision:",text

# show the output image
# cv2.imshow("Image", output)
# cv2.waitKey(0)
outname = args["image"].split("/")[-1].replace(".jpg",".png")
cv2.imwrite("predictions/prediction_"+outname, output)